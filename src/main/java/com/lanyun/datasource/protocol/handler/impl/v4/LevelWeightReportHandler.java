 ...
 */
@Component
public class LevelWeightReportHandler extends AbstractMessageHandler {
    ...
    public boolean support(DeviceMessage input) {
        return input != null &&
                Version_4_CmdEnum.UP_LEVEL_WEIGHT_INFO.equals(Version_4_CmdEnum.getCmd(input.getCmd()));
    }
}
