 ...
 */
@Component
public class DeviceVoltageInfoHandler extends AbstractMessageHandler{
    ...
    public boolean support(DeviceMessage input) {
        return input != null && DeviceCmdEnum.getCmd(input.getCmd()) == DeviceCmdEnum.UP_DEVICE_VOLTAGE;
    }
}
